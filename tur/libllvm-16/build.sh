...
TERMUX_PKG_SRCURL=https://github.com/bylaws/llvm-project/archive/refs/heads/eceh.tar.gz
TERMUX_PKG_SHA256=d6c29f24ea01d3bf2449265d6be4c197fe1367950fb19ceede6d500d4cf52f66
...
termux_step_post_make_install() {
	# Fix: Use relative paths for symlinks
	ln -sf "../$_INSTALL_PREFIX_R/bin/clang-16" "$TERMUX_PREFIX/bin/clang-16"

	ln -sf "../$_INSTALL_PREFIX_R/bin/lld" "$TERMUX_PREFIX/bin/lld-16"
	ln -sf "lld" "$_INSTALL_PREFIX/bin/lld-16"
	ln -sf "../$_INSTALL_PREFIX_R/bin/ld.lld" "$TERMUX_PREFIX/bin/ld.lld-16"

	ln -sf "../$_INSTALL_PREFIX_R/lib/libLLVM-16.so" "$TERMUX_PREFIX/lib/libLLVM-16.so"
	ln -sf "../$_INSTALL_PREFIX_R/lib/libLLVM-16.0.0.so" "$TERMUX_PREFIX/lib/libLLVM-16.0.0.so"
}
